  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-6 text-center space-y-8">
      ...
      <div className="space-y-4">
        <h2 className="text-4xl font-black uppercase tracking-widest text-foreground">Lost in the Gallery?</h2>
        <p className="text-muted-foreground text-lg max-w-md mx-auto">
          It seems the masterpiece you're looking for has been moved or doesn't exist yet. Let's get you back to safety.
        </p>
      </div>
      <Link href="/">
        <Button size="lg" className="rounded-full h-14 px-10 text-xs font-bold uppercase tracking-widest gradient-primary">
